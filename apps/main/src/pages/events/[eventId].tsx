...
const EVENT: EventDetailType = {
  ...
  name: '밤 하늘의 별',
  artistName: '디렌리',
  date: new Date(2022, 7, 22).getTime() - 9 * 60 * 60 * 1000,
  description:
  ...
  salesFrom: new Date(2022, 7, 11).getTime() - 9 * 60 * 60 * 1000,
  salesTo: new Date(2022, 7, 16).getTime() - 9 * 60 * 60 * 1000,
  ...
  onSaleTicketCount: 6,
  price: 10000,
  startTime: new Date(2022, 7, 22, 19, 30).getTime() - 9 * 60 * 60 * 1000,
  endTime: new Date(2022, 7, 22, 21, 30).getTime() - 9 * 60 * 60 * 1000,
